--------------------------------------------------------
--  File created - pi¹tek-grudnia-14-2018   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table LOT_PRACOWNIK_ADMINISTRACYJNY
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table SAMOLOT_PRACOWNIK_TECHNICZNY
--------------------------------------------------------
...
Insert into BILET (ID_BILETU,CENA,RZAD,TYP_MIEJSCA,ID_KLIENTA,ID_LOTU) values ('4','800','12','srodek','1','2');
...
SET DEFINE OFF;
Insert into LOT (ID_LOTU,ID_SAMOLOTU,ID_LOTNISKA_WYLOTU,ID_LOTNISKA_PRZYLOTU,CENA_BILETU,DATA_LOTU) values ('1','1','1','2','1000',to_date('18/11/23 17:01','RR/MM/DD HH24:MI'));
Insert into LOT (ID_LOTU,ID_SAMOLOTU,ID_LOTNISKA_WYLOTU,ID_LOTNISKA_PRZYLOTU,CENA_BILETU,DATA_LOTU) values ('3','1','3','1','300',to_date('18/12/12 00:00','RR/MM/DD HH24:MI'));
Insert into LOT (ID_LOTU,ID_SAMOLOTU,ID_LOTNISKA_WYLOTU,ID_LOTNISKA_PRZYLOTU,CENA_BILETU,DATA_LOTU) values ('5','1','3','2','500',to_date('18/12/14 08:52','RR/MM/DD HH24:MI'));
...
Insert into LOT (ID_LOTU,ID_SAMOLOTU,ID_LOTNISKA_WYLOTU,ID_LOTNISKA_PRZYLOTU,CENA_BILETU,DATA_LOTU) values ('2','1','2','1','800',to_date('18/12/14 10:11','RR/MM/DD HH24:MI'));
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SAMOLOT_PRACOWNIK_TECHNICZ_PK
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table ZAJETE_MIEJSCA
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  Constraints for Table LOT_PRACOWNIK_ADMINISTRACYJNY
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  Constraints for Table SAMOLOT_PRACOWNIK_TECHNICZNY
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LOT" ADD CONSTRAINT "FK_LOT_LOTNISKO_PRZYL" FOREIGN KEY ("ID_LOTNISKA_PRZYLOTU")
	  REFERENCES "LOTNISKO" ("ID_LOTNISKA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LOT_PRACOWNIK_ADMINISTRACYJNY
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "PRACOWNIK_TECHNICZNY" ADD CONSTRAINT "ID_ADMINISTRATORA" FOREIGN KEY ("ID_ADMINISTRATORA")
	  REFERENCES "ADMINISTRATOR" ("ID_ADMINISTRATORA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SAMOLOT_PRACOWNIK_TECHNICZNY
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "UZYTKOWNIK" ADD CONSTRAINT "FK_U_PRAC_TECH" FOREIGN KEY ("ID_PRAC_TECH")
	  REFERENCES "PRACOWNIK_TECHNICZNY" ("ID_PRACOWNIKA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ZAJETE_MIEJSCA
--------------------------------------------------------
